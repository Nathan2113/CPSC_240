...
This file:
  ...
  Assemble (standard): gcc  -m64 -Wall -no-pie -o output_array.o -std=c2x -c output_array.c
  Optimal print specification: Landscape, 7 points, monospace, 8½x11 paper
  Prototype of this function: void output_array(double *arr, int size)
***********************************************************************************************************************************/
...
//End of the function output_array.c ====================================================================