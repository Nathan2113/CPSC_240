...
;   Prototype of this function: void show_array(double *arr, int size);
; ***********************************************************************************************************************************/
...
; column_header_output db "IEEE %18s\nScientific Decimal"
header_output db "IEEE754			Scientific Decimal", 10, 0
...
show_array:
    ...
    ;Establish show_array variables
...
begin:
    ...
    ;Output the values in this index of the array
    mov rax, 1
...
quit:
    ...
    ret
;End of the function show_array.asm ====================================================================