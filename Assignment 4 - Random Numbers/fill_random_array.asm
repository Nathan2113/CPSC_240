...
;   Prototype of this function: void fill_random_array(double *arr, int size);
; ***********************************************************************************************************************************/
...
fill_random_array:
    ...
    mov r14, rsi ;r14 is the max number of values that can be in the array (input from user)
...
begin:
    ...
    xor r12, r12 ;Initializes r12 to 0
    ...
    mov [r13+r15*8], r12 ;r12 is the random number
    inc r15

    jmp begin


quit_loop: ;No more looping - restore regs, but save r13 (the array)
    ...
    ret
;End of the function fill_random_array.asm ====================================================================